  ...
  return {
    light: {
      palette: {
        ...
        background: {
          default: skin === 'bordered' ? '#FFFFFF' : '#f8f8f8', // $body-bg: #f8f8f8
          paper: '#FFFFFF',
